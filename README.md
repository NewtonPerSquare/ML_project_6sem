...
Общая информация
Данный проект представляет собой реализацию MVP MLOps-конвейера для обработки потоковых табличных данных на языке Python. Проект соответствует заданию из курса "Технологическая практика", реализован без использования MLOps-фреймворков.

Построение ML-системы обработки
потоковых данных (Задание 1)
...
Этап 1 был реализован Паскаль Егором, этапы 2, 3 - Холевенковой Варварой.
